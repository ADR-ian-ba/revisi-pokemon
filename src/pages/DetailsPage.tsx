...
import { fetchPokemonDetail } from "../Repository/RemoteRepository";
...
const DetailsPage = () => {
  ...
  useEffect(() => {
    if (id !== null) {
      fetchPokemonDetail(id).then((res) => setPokemonDetails(res));
    }
  }, [id]);
  ...
  return (
    <div className="details-page">
      ...
      >
        ...
        >
          ...
          <CardContent>
            ...
            >
              <Typography variant="h5" className="p-details">
                PokedexId : {id}
              </Typography>
              <Typography variant="h5" className="p-details">
      ...
      <Link
        to="/"
        style={{ paddingBottom: "5rem", color: "#000", textDecoration: "none" }}
      >
        Back
      </Link>
    </div>
